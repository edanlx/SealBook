...
![公众号](http://seal_li.gitee.io/sealbook/pic/wechat.jpg)
  ...
  1. 优雅代码
        ...
        11. [stream精选/@functional懒加载示例](./01graceCode/11stream.md)
        12. [hessian、kryo、json序列化大对比](./01graceCode/12serialize.md)
        13. [linkedList插入真的比arrayList快么](./01graceCode/13listSpeed.md)
        14. [guava精选方法及eventBus观察者模式源码解析](./01graceCode/14guava.md)
        15. [guavaCache本地缓存使用及源码解析](./01graceCode/15localeCache.md)
        16. [guava布隆过滤与限流算法源码解析](./01graceCode/16bloomAndRate.md)
