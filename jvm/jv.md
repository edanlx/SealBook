...
# 二.jre和jdk的关系
![jre和jdk的关系](https://github.com/edanlx/SealBook/tree/master/tools/picJDKwithJRE.png)
# 三.运行时数据区域
![运行时数据区域](https://github.com/edanlx/SealBook/tree/master/tools/picruntiemDataArea.jpg)
## 程序计数器
...
## 官方给出的存放至常量池的内容
![常量池](https://github.com/edanlx/SealBook/tree/master/tools/picConstantPoolType.jpg)
...
![运行时栈桢结构](https://github.com/edanlx/SealBook/tree/master/tools/picstackFrame.jpg)
## 局部变量表
...
![操作栈共享区域](https://github.com/edanlx/SealBook/tree/master/tools/picStackFrameDataShare.jpg)
