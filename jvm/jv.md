...
# 二.jre和jdk的关系
![jre和jdk的关系](https://github.com/edanlx/SealBook/tree/master/tools/pic/JDKwithJRE.png)
# 三.运行时数据区域
![运行时数据区域](https://github.com/edanlx/SealBook/tree/master/tools/pic/runtiemDataArea.jpg)
## 程序计数器
...
## 官方给出的存放至常量池的内容
![常量池](https://github.com/edanlx/SealBook/tree/master/tools/pic/ConstantPoolType.jpg)
...
![运行时栈桢结构](https://github.com/edanlx/SealBook/tree/master/tools/pic/stackFrame.jpg)
## 局部变量表
...
![操作栈共享区域](https://github.com/edanlx/SealBook/tree/master/tools/pic/StackFrameDataShare.jpg)
